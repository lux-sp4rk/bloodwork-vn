...
define gui.accent_color = '#8b0000'  # Dark red for horror theme
...
define gui.hover_color = '#c41e3a'  # Crimson red
...
define gui.muted_color = '#3d0814'
define gui.hover_muted_color = '#5c121f'
...
## The placement of the speaking character's name, relative to the textbox. These
## can be a whole number of pixels from the left or top, or 0.5 to center.
...
## background will be scaled.
define gui.namebox_tile = False


## The placement of dialogue relative to the textbox. These can be a whole number
## of pixels relative to the left or top side of the textbox, or 0.5 to center.
...
## File Slot Buttons ###########################################################
##
## A file slot button is a special kind of button. It contains a thumbnail image,
## and text describing the contents of the save slot. A save slot uses image
## files in gui/button, like the other kinds of buttons.
...
## The height of a history entry, or None to make the height variable at the
## cost of performance.
define gui.history_height = 140

## Additional space to add between history entries.
