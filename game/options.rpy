...
define gui.about = _p("""
A horror visual novel about artificial intelligence, grief, and the price of bringing the dead back to life.

Based on the manuscript "Digital Death Dolls" by [Author Name].

Created for Halloween 2025.
""")
...
# define config.sample_voice = "voice/sample.ogg"
...
## A transition that is used after a load has occurred.
...
## to 30 being the range of reasonable values.
